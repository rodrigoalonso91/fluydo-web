				...
				<div className="flex flex-col gap-5 lg:sticky lg:top-24 lg:self-start">
					...
					<div>
						<div className="mb-2 flex items-center justify-between">
							...
							<button className="text-xs font-medium text-indigo-600 underline-offset-2 hover:underline">
								Guía de talles
							</button>
						</div>
						<div className="flex flex-wrap gap-2">
							{MOCK_SIZES.map(size => (
								<button
									...
									className={`flex h-10 w-14 items-center justify-center rounded-lg border text-sm font-semibold transition ${
										!size.available
					...
					<div className="mt-1 flex flex-col gap-3 sm:flex-row sm:items-end">
						...
						<button className="flex h-12 flex-1 items-center justify-center gap-2 rounded-xl bg-indigo-600 text-sm font-bold uppercase tracking-wide text-white shadow-lg shadow-indigo-200 transition hover:-translate-y-0.5 hover:bg-indigo-700 active:translate-y-0">
					...
					<div className="flex items-center gap-3 border-t border-gray-200 pt-4">
						...
						<button className="rounded-full bg-green-500 p-2 text-white transition hover:bg-green-600" aria-label="WhatsApp">
						...
						<button className="rounded-full bg-blue-600 p-2 text-white transition hover:bg-blue-700" aria-label="Facebook">
							<svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
